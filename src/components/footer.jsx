        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              seamless, safe, and reliable travel solutions across all major
              cities. From airport transfers to corporate travel, events,
              leisure trips, and outstation journeys — we provide a premium
              fleet with verified chauffeurs and 24/7 customer support to ensure
          ...
          <div className="md:col-span-6">
            <div className="grid grid-cols-12">
              <div className="col-span-6">
                <h3 className="text-xl font-bold font-grotesk mb-6">
                  Quick Links
                </h3>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="group flex items-center gap-2 cursor-pointer bg-[#1f2933] px-5 py-2.5 text-sm font-grotesk font-semibold text-white rounded-xl border border-gray-700 hover:bg-[#273443] hover:border-orange-500/60 transition-all duration-300
  "
            >
              Login as Vendor
              <span className="text-orange-400 transform group-hover:translate-x-1 transition">
                →
              </span>
            </button>
