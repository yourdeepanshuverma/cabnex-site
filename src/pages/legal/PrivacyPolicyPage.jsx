        ...
        <div className="max-w-7xl mx-auto py-32 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 font-grotesk">
            ...
            <p className="text-lg text-gray-600">
              ...
              Nexfleet Tech Solutions Pvt. Ltd.).Your privacy is important to
              us. This Privacy Policy explains how we collect, use, disclose,
              and safeguard your information when you visit our website
              www.cabnex.in or use our travel and transport services. Please
            ...
            <p className="mt-4 text-lg text-gray-600">
              We collect personal and non-personal information to provide you
            ...
            <p className="mt-2 text-lg text-gray-600">
              When you book a service, contact us, or register on our platform,
              we may collect:
            </p>
            ...
            <ul className="list-disc list-inside mt-2 text-lg text-gray-600">
              ...
              <li>
                To improve our website, customer experience, and fleet services
              </li>
              <li>
            ...
            <ul className="list-disc list-inside mt-2 text-lg text-gray-600">
              <li>
                With our drivers, partner vendors, or service affiliates for
                operational purposes
              </li>
              <li>With payment processors for secure transactions</li>
              <li>
                When required by law, regulation, or government authorities
              </li>
            </ul>
            <p className="mt-2 text-lg text-gray-600">
              All partners and affiliates are bound by confidentiality
              agreements to protect your information.
            </p>
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              data.Our website uses SSL encryption, and sensitive data (like
              payment details) is transmitted securely through certified payment
              gateways.
            </p>
            ...
            <ul className="list-disc list-inside mt-2 text-lg text-gray-600">
              ...
              <li>
                Analyze website traffic via tools such as Google Analytics
              </li>
            </ul>
            <p className="mt-2 text-lg text-gray-600">
              You can disable cookies through your browser settings, but certain
            ...
            <p className="mt-4 text-lg text-gray-600">You have the right to:</p>
            <ul className="list-disc list-inside mt-2 text-lg text-gray-600">
              <li>Access, update, or delete your personal data</li>
              <li>
                Withdraw consent to data usage (subject to service limitations)
              </li>
            ...
            <p className="mt-4 text-lg text-gray-600">
              Our website may contain links to third-party websites.Cabnex is
              not responsible for the content or privacy practices of these
              external sites. We recommend reviewing their respective privacy
              policies.
            </p>
            ...
            <p className="mt-4 text-lg text-gray-600">
              Cabnex reserves the right to modify this Privacy Policy at any
              time. Updates will be posted on this page with the revised
              effective date. Continued use of our services indicates acceptance
              of any changes.
            </p>
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              our data handling practices, please contact:
            </p>
