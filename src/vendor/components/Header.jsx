...
const Header = ({ setIsOpen, isOpen }) => {
  ...
  const handleViewNotification = (bookingId) => {
    ...
    setVendorStats((prevStats) => ({
      ...prevStats,
      recentBookings: prevStats.recentBookings.filter(
      ...
      <div className="flex items-center gap-2 space-x-4">
        <div className="relative">
          <button
            ...
            className="bg-[#F3F4F6] cursor-pointer p-4 rounded-xl text-orange-500 hover:text-black relative"
              ...
              <div className="max-h-64 overflow-y-auto">
                {vendorStats?.recentBookings?.map((booking) => (
                  <div
                    ...
                    className="p-4 border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 flex justify-between items-center"
                  >
                    <div>
                    ...
                    <button
                      onClick={() => handleViewNotification(booking.bookingId)}
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-gray-700 dark:text-gray-200 font-grotesk font-medium">
              {vendorUser?.contactPerson || "Vendor"}
            </span>
          </button>
          {profileDropdown && (
